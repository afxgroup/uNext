...
MainMenu::MainMenu(void) {
	...
	this->lMO.push_back(new MenuOption("QUIT", 244, 372));
...
void MainMenu::Draw(SDL_Renderer* rR) {
	...
	Menu::Draw(rR);
	CCFG::getText()->Draw(rR, "WWW.LUKASZJAKOWSKI.PL - AMIGAOS4 PORT BY AMIGASOFT.NET", 4, CCFG::GAME_HEIGHT - 4 - 8, 8, 0, 0, 0);
	CCFG::getText()->Draw(rR, "WWW.LUKASZJAKOWSKI.PL - AMIGAOS4 PORT BY AMIGASOFT.NET", 5, CCFG::GAME_HEIGHT - 5 - 8, 8, 255, 255, 255);
