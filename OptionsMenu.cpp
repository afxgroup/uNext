...
OptionsMenu::OptionsMenu(void) {
	...
	this->lMO.push_back(new MenuOption("VOLUME", MENUX0, 65));
	this->lMO.push_back(new MenuOption("LEFT", MENUX0, 89));
	this->lMO.push_back(new MenuOption("DOWN", MENUX0, 113));
	this->lMO.push_back(new MenuOption("RIGHT", MENUX0, 137));
	this->lMO.push_back(new MenuOption("JUMP", MENUX0, 161));
	this->lMO.push_back(new MenuOption("RUN", MENUX0, 185));
	this->lMO.push_back(new MenuOption("CAN MOVE BACKWARD", MENUX0, 209));
	this->lMO.push_back(new MenuOption("FULLSCREEN", MENUX0, 233));
	this->lMO.push_back(new MenuOption("MAIN MENU", MENUX0, 257));
...
void OptionsMenu::Draw(SDL_Renderer* rR) {
	...
	CCFG::getMM()->getActiveOption()->Draw(rR, lMO[activeMenuOption]->getXPos() - 20, lMO[activeMenuOption]->getYPos());
	...
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDA), MENUX1, 89, 16, activeMenuOption == 1 ? 255 : 90, activeMenuOption == 1 ? 255 : 90, activeMenuOption == 1 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDS), MENUX1, 113, 16, activeMenuOption == 2 ? 255 : 90, activeMenuOption == 2 ? 255 : 90, activeMenuOption == 2 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDD), MENUX1, 137, 16, activeMenuOption == 3 ? 255 : 90, activeMenuOption == 3 ? 255 : 90, activeMenuOption == 3 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDSpace), MENUX1, 161, 16, activeMenuOption == 4 ? 255 : 90, activeMenuOption == 4 ? 255 : 90, activeMenuOption == 4 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::getKeyString(CCFG::keyIDShift), MENUX1, 185, 16, activeMenuOption == 5 ? 255 : 90, activeMenuOption == 5 ? 255 : 90, activeMenuOption == 5 ? 255 : 90);

	CCFG::getText()->Draw(rR, CCFG::canMoveBackward ? "TRUE" : "FALSE", 367, 209, 16, activeMenuOption == 6 ? 255 : 90, activeMenuOption == 6 ? 255 : 90, activeMenuOption == 6 ? 255 : 90);
	CCFG::getText()->Draw(rR, CCFG::fullscreen ? "TRUE" : "FALSE", 367, 233, 16, activeMenuOption == 6 ? 255 : 90, activeMenuOption == 6 ? 255 : 90, activeMenuOption == 6 ? 255 : 90);
